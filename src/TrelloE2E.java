...
//		
		...
		String listToDoId = jsListToDo.getString("id");
...
//		
		...
		String listCompletedId = jsListCompleted.getString("id");
...
//		// print name matching with input data, boardId, list is opened [“closed” : “false”]
		...
		String listInTestingId = jsListInTesting.getString("id");
		...
		String listDoneId = jsListDone.getString("id");
		...
		String listDeployedId = jsListDeployed .getString("id");
...
////		   list name matching the input data, assert ListId and BoardId in response.
		...
		String cardsAPI_ID = jsCardsAPI.getString("id");
